...
echo -e "     ${BICyan}[${BIGreen}5${BICyan}]${BIGreen} Check User Login  ${NC}   "
echo -e "     ${BICyan}[${BIGreen}6${BICyan}]${BIGreen} MultiLogin SSH   ${NC}  "
echo -e "     ${BICyan}[${BIGreen}7${BICyan}]${BIGreen} Auto Del user Exp  ${NC}   "
echo -e "     ${BICyan}[${BIGreen}8${BICyan}]${BIGreen} Auto Kill user SSH ${NC}   "
echo -e "     ${BICyan}[${BIGreen}9${BICyan}]${BIGreen} Check SSH Accounts ${NC}"
