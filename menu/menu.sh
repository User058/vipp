...
clear
echo -e " ${BIBlue}           ┌───────────────────────────────┐$NC"
echo -e " ${BIBlue}           │          ${NC}${BIBlue}.::.${BIYellow}USER058${BIBlue}.::.$NC    " ${BIBlue} │
echo -e " ${BIBlue}           └───────────────────────────────┘$NC"
echo -e "${BIBlue} ┌─────────────────────────────────────────────────────┐${NC}"
...
echo -e " ${BIBlue}│$NC  $y ISP ${NC}              $Blue:$NC  $(cat /root/.myisp)${NC}"
echo -e " ${BIBlue}│$NC  $y CITY ${NC}             $Blue:$NC  $(cat /root/.mycity)${NC}"
...
0) clear ; menu ;;
x) exit ;;
*) echo -e "" ; echo "Press any key to back exit" ; sleep 0 ; menu ;;
esac
