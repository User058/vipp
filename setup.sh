...
wget -q -O /usr/bin/restore "https://raw.githubusercontent.com/User058/vipp/main/menu/restore.sh" && chmod +x /usr/bin/restore
wget -q -O /usr/bin/backup "https://raw.githubusercontent.com/User058/vipp/main/menu/backup.sh" && chmod +x /usr/bin/backup
